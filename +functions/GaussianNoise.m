...
[PSA_RM,~,~]=functions.RSNewmark(Operators.ResampledReal_Motion,Operators.Fr,Operators.w(1:end-1),Operators.z);
[PSA_NM,~,~]=functions.RSNewmark(Operators.New_Motion,Operators.Fr,Operators.w(1:end-1),Operators.z);
...
set(MethodButtons{2}.Button{4},'Enable','on')
    ...
    set(IM.Buttons{1}.Edit{10}, 'String', num2str(Operators.PGA_RM))
    set(IM.Buttons{1}.Edit{11}, 'String', num2str(Operators.CAV_RM))
    set(IM.Buttons{1}.Edit{12}, 'String', num2str(max(Operators.AI_RM)))
    set(IM.Buttons{1}.Edit{13}, 'String', num2str(max(Operators.Ic_RM)))
    set(IM.Buttons{1}.Edit{14}, 'String', num2str(max(Operators.Arms_RM)))
    set(IM.Buttons{1}.Edit{15}, 'String', num2str(max(Operators.ASI_RM)))
    set(IM.Buttons{1}.Edit{16}, 'String', num2str(max(Operators.AIRM_t5)))
    set(IM.Buttons{1}.Edit{17}, 'String', num2str(max(Operators.DsRM)))
    set(IM.Buttons{1}.Edit{18}, 'String', num2str(max(Operators.AIRM_t95)))
